class AddCachedLikesToMemes < ActiveRecord::Migration[5.1]
  def self.up
    ...
    add_column :memes, :cached_weighted_score, :integer, :default => 0
    add_column :memes, :cached_weighted_total, :integer, :default => 0
    add_column :memes, :cached_weighted_average, :float, :default => 0.0
    ...
    add_index  :memes, :cached_weighted_score
    add_index  :memes, :cached_weighted_total
    add_index  :memes, :cached_weighted_average
  ...
  def self.down
    ...
    remove_column :memes, :cached_weighted_score
    remove_column :memes, :cached_weighted_total
    remove_column :memes, :cached_weighted_average
  end
end

...
ActiveRecord::Schema.define(version: 20170728092505) do
  ...
  create_table "memes", force: :cascade do |t|
    ...
    t.index ["cached_weighted_average"], name: "index_memes_on_cached_weighted_average"
    t.index ["cached_weighted_score"], name: "index_memes_on_cached_weighted_score"
    t.index ["cached_weighted_total"], name: "index_memes_on_cached_weighted_total"
